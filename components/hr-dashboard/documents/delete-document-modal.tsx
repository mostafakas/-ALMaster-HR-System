        ...
        <div className="flex flex-col items-center gap-[40px] p-[32px]">
          ...
          <div className="flex flex-col items-center gap-[8px] w-full">
            ...
            <p className="font-bold text-[18px] text-[#343434] leading-[28px] font-janna text-center w-full">
              This document will be permanently removed from the system. This action cannot be undone.
            </p>
          </div>
          ...
          <div className="flex items-center gap-[8px] w-full">
            ...
            <button
              ...
              <span className="text-[12px] font-bold text-white font-janna">Remove Document</span>
            </button>
          </div>
        </div>
      </DialogContent>
