      ...
      >
        <div className="flex flex-col items-center gap-[40px] p-[32px]">
          ...
          <div className="flex flex-col items-center gap-[8px] w-full">
            <div className="size-[140px] bg-[rgba(243,131,40,0.1)] rounded-full flex items-center justify-center">
              <Ban className="size-[56px] text-[#F38328]" strokeWidth={1.5} />
            </div>
            <h2 className="font-bold text-[24px] text-[#F38328] font-janna text-center">
              Suspend Employee?
            </h2>
          ...
          <div className="flex items-center gap-[8px] w-full">
            ...
            <button
              ...
              className="flex-1 h-[40px] bg-[#F38328] hover:bg-[#e0751e] rounded-[12px] flex items-center justify-center gap-[8px] transition-colors active:scale-[0.98]"
            >
              <Ban className="size-[12px] text-white" />
              <span className="text-[12px] font-bold text-white font-janna">Suspend Employee</span>
            </button>
          </div>
        </div>
      </DialogContent>
